# <p align='center'>0x02. Python - import & modules</p>
...
Solution: [1-calculation.py](1-calculation.py).
...
![image](https://github.com/Bebo-K-S/alx-higher_level_programming/assets/107813045/03d4b171-309c-4a98-9811-57cf5e94b180)


<br>

Solution: [3-infinite_add.py](3-infinite_add.py).
...
Solution: [4-hidden_discovery.py](4-hidden_discovery.py).
...
Solution: [5-variable_load.py](5-variable_load.py).
...
Solution: [100-my_calculator.py](100-my_calculator.py).
...
Solution: [101-easy_print.py](101-easy_print.py).
...
Solution: [103-fast_alphabet.py](103-fast_alphabet.py).
