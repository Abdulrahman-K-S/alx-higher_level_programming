# <p align='center'>0x01-python-if_else_loops_functions</p>

![image](https://github.com/Bebo-K-S/alx-higher_level_programming/assets/107813045/d643b246-23c4-4409-8a86-7d35061be9e3)
...
This program will assign a random signed number to the variable      each time it is executed. Complete the source code in order to print whether the number stored in the variable `number` is positive or negative.
...
Solution: [0-positive_or_negative.py](0-positive_or_negative.py).
...
Solution: [1-last_digit.py](1-last_digit.py).
...
Solution: [2-print_alphabet.py](2-print_alphabet.py).
...
Solution: [3-print_alphabt.py](3-print_alphabt.py).
...
Solution: [4-print_hexa.py](4-print_hexa.py).
...
Solution: [5-print_comb2.py](5-print_comb2.py).
...
Solution: [6-print_comb3.py](6-print_comb3.py).
...
Solution: [7-islower.py](7-islower.py).
...
Solution: [8-uppercase.py](8-uppercase.py).
...
Solution: [9-print_last_digit.py](9-print_last_digit.py).
...
Solution: [12-fizzbuzz.py](12-fizzbuzz.py).
...
Solution: [13-insert_number.c](13-insert_number.c).
...
Solution: [100-print_tebahpla.py](100-print_tebahpla.py).
...
Solution: [101-remove_char_at.py](101-remove_char_at.py).
